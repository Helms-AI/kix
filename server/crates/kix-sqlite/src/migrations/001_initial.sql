...
-- Full-Text Search
-- ===========================================================================
-- NOTE: Full-text search is now provided by Tantivy (kix-search crate).
-- FTS5 virtual tables and triggers have been removed.
-- The search index is maintained separately in the data/search/ directory.
